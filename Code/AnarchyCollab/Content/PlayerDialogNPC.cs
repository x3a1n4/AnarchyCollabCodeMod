...
namespace Celeste.Mod.AnarchyCollab2022.Content {
    ...
    public class PlayerDialogNPC : NPC {
        ...
        public PlayerDialogNPC(EntityData data, Vector2 off, EntityID id) : base(data.Position + off) {
            ...
            if(dialogAnimations != null && dialogIds != null && dialogAnimations.Length == 1) dialogAnimations = Enumerable.Repeat(dialogAnimations[0], dialogIds.Length).ToArray();
        ...
        public override void Update() {
            ...
            //Play animations
            if((dialogAnimation ?? idleAnimation) != null) Sprite.Play(dialogAnimation ?? idleAnimation, false);
        }
        ...
        private void OnTalkEnd(Level level) {
            ...
            if(Level.Session.GetCounter($"{id}TalkCounter") >= dialogIds.Length) {
                ...
                if(loopDialog) Level.Session.SetCounter($"{id}TalkCounter", 0);
                else {
                    Talker.RemoveSelf();
                    Talker = null;
                }
